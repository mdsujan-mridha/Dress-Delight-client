                            ...
                            <div className="border-b border-gray-200 md:flex-row flex-col flex justify-between items-start w-full pb-8 space-y-4 md:space-y-0">
                                <div className="w-full flex flex-col justify-start items-start space-y-8">
                                    ...
                                    <div className="flex justify-start items-start flex-col space-y-2">
                                        ...
                                        <p className="text-sm  leading-none text-gray-800"><span className="text-black">Size: </span> Small</p>
                                        <p className="text-md text-black"><span className="">Color: </span> Light Blue</p>
                                    </div>
                                </div>
                    ...
                    <div className="flex justify-center md:flex-row flex-col items-stretch w-full space-y-4 md:space-y-0 md:space-x-6 xl:space-x-8">
                        <div className="flex flex-col px-4 py-6 md:p-6 xl:p-8 w-full bg-gray-50 space-y-6">
                            ...
                            <div className="flex justify-center items-center w-full space-y-4 flex-col border-gray-200 border-b pb-4">
                                ...
                                <div className="flex justify-between items-center w-full">
                                    <p className="text-base leading-4 text-gray-800">Discount <span className="bg-gray-200 p-1 text-xs font-medium  dark:text-gray-800 leading-3 text-gray-800">STUDENT</span></p>
                        ...
                        <div className="flex flex-col justify-center px-4 py-6 md:p-6 xl:p-8 w-full bg-gray-50 space-y-6">
                            ...
                            <div className="w-full flex justify-center items-center">
                                <button className="bg-accent w-full h-14 rounded-lg text-white">View Carrier Details</button>
                            </div>
                        </div>
                    </div>
                </div>
