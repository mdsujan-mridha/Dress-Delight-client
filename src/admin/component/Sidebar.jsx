    ...
    return (
        <div className='flex flex-col gap-5 rounded-md min-h-screen bg-blue-400 shadow-xl items-start px-2'>
            ...
            <div className='flex flex-col  gap-5 items-start'>
                ...
                <Link to="/admin/reviews" className='text-center flex gap-5  items-center justify-start'>
                    <MdOutlinePreview className='text-2xl text-white' />
                    <h1 className='text-2xl text-white text-center'> Reviews </h1>
                </Link>
                <Link to="/admin/users" className='text-center flex gap-5  items-center justify-start'>
